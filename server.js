// server.js - Katsina Noma Backend (Clean Final Version)
...
if (!GEMINI_API_KEY) {
  ...
  console.error("Please add GEMINI_API_KEY=your_key_here in your .env file");
}
...
// Helper to extract reply safely
const getReply = (data) => {
